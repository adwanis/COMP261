...
public class Stop implements Comparable<Stop> {    
    ...
    //Part3
    private Collection<Stop> neighbours = new HashSet<>();
    ...
    public void addNeighbour(Stop s){
        neighbours.add(s);
    }
    
    public void removeNeighbour(Stop s){
        neighbours.remove(s);
    }
    ...
    public void deleteNeigOfType(String type) {
        
        //neighbours.removeIf((Edge e)->type.equals(e.transpType()));
    }
